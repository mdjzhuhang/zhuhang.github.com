...
[webassembly 是什么](https://www.tuicool.com/articles/2euQRf3)：面向Web的通用二进制和文本格式。非js语言写的源码编译成`.wasm`文件，再引入到前端工程中，最后[实例化](https://zhuanlan.zhihu.com/p/28220315)。

[14行JavaScript教你使用WebAssembly](http://kuaibao.qq.com/s/20180503A19VIF00?refer=cp_1026)

[chrome 页面渲染原理](http://www.360doc.com/content/18/0118/18/38081862_723131838.shtml)
